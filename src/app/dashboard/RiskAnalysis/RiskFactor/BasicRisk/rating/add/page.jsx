...
import BasicRatingNewEditForm from 'src/sections/BasicRating/BasicRating-new-edit-form';
        ...
        <CustomBreadcrumbs
          ...
          links={[
            ...
            // { name: 'Basic Risk', href: paths.dashboard.RiskAnalysis.RiskFactor.BasicRisk.root },
            {
              ...
              href: paths.dashboard.RiskAnalysis.RiskFactor.BasicRisk.rating.root,
            },
            { name: 'Add ' },
          ]}
          sx={{
