...
import NonCompliantRiskQuickEditForm from './NonCompliantRisk-quick-edit-form';
...
export default function NonCompliantRiskTableRow({
  row,
  selected,
  onEditRow,
  onSelectRow,
  ...
  const { CountryName, NonCompliantName, Discription, NonCompliantRisk, NonCompliantRiskID } = row;
  ...
  return (
    <>
      <TableRow hover selected={selected}>
        ...
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{NonCompliantName}</TableCell>
        <TableCell sx={{ whiteSpace: '' }}>{Discription}</TableCell>
        <TableCell sx={{ whiteSpace: '', textAlign: 'center' }}>{NonCompliantRisk}</TableCell>
      ...
      <NonCompliantRiskQuickEditForm
        currentNonCompliantRisk={row}
...
NonCompliantRiskTableRow.propTypes = {
