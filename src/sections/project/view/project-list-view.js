...
import { _roles, _projectList, PROJECT_STATUS_OPTIONS } from 'src/_mock';
...
const TABLE_HEAD = [
  { id: 'id', label: 'No.', width: 88 },
  { id: 'Name', label: 'Name', width: 220 },
  { id: 'ProjectDescription', label: 'Project Description', width: 280 },
...
export default function ProjectListView() {
  ...
  const [tableData, setTableData] = useState(_projectList);
        ...
        <CustomBreadcrumbs
          ...
          action={
            <Button
              ...
              href="/dashboard/project-database/add-project"
              variant="contained"
              color="primary"
...
function applyFilter({ inputData, comparator, filters }) {
  ...
  if (role.length) {
    inputData = inputData.filter((project) => role.includes(project.role));
  }
