...
import { SUPPLIER_STATUS_OPTIONS } from 'src/_mock';
...
export default function SupplierQuickEditForm({ currentSupplier, open, onClose }) {
...
SupplierQuickEditForm.propTypes = {
  open: PropTypes.bool,
