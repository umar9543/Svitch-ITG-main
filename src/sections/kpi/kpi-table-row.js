...
export default function KpiTableRow({ row, selected, onEditRow, onSelectRow, onDeleteRow }) {
  ...
  return (
    <>
      ...
      <KpiQuickEditForm currentKpi={row} open={quickEdit.value} onClose={quickEdit.onFalse} />
