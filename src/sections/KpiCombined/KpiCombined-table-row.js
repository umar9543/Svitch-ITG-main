...
import KpiCombinedQuickEditForm from './KpiCombined-quick-edit-form';

// ----------------------------------------------------------------------

export default function KpiCombinedTableRow({
  row,
  selected,
  onEditRow,
  onSelectRow,
  ...
  return (
    <>
      ...
      <KpiCombinedQuickEditForm
        currentKpiCombined={row}
