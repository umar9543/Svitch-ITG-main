...
import OnBoardingSelfQuickEditForm from './OnBoardingSelf-quick-edit-form';
import { Chip } from '@mui/material';

// ----------------------------------------------------------------------

export default function OnBoardingSelfTableRow({
  row,
  selected,
  onEditRow,
  onSelectRow,
  ...
  return (
    <>
      ...
      <OnBoardingSelfQuickEditForm
        currentOnBoardingSelf={row}
...
OnBoardingSelfTableRow.propTypes = {
