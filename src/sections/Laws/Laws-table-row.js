...
import LawsQuickEditForm from './Laws-quick-edit-form';

// ----------------------------------------------------------------------

export default function LawsTableRow({ row, selected, onEditRow, onSelectRow, onDeleteRow }) {
  ...
  return (
    <>
      ...
      <LawsQuickEditForm currentLaws={row} open={quickEdit.value} onClose={quickEdit.onFalse} />
