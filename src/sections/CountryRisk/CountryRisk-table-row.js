...
import CountryRiskQuickEditForm from './CountryRisk-quick-edit-form';
...
export default function CountryRiskTableRow({
  row,
  selected,
  onEditRow,
  onSelectRow,
  ...
  return (
    <>
      ...
      <CountryRiskQuickEditForm
        currentCountryRisk={row}
