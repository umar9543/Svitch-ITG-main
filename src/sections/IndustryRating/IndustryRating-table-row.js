...
import IndustryRatingQuickEditForm from './IndustryRating-quick-edit-form';
...
export default function IndustryRatingTableRow({
  row,
  selected,
  onEditRow,
  onSelectRow,
  ...
  return (
    <>
      <TableRow hover selected={selected}>
        ...
        <TableCell sx={{ whiteSpace: 'wrap' }}>{IndustryName}</TableCell>
        ...
        <TableCell sx={{ whiteSpace: 'nowrap', textAlign: 'right' }}>
          <Tooltip title="Edit" placement="top" arrow>
            <IconButton
              ...
              onClick={() => {
                router.push(
                  `/dashboard/RiskAnalysis/RiskFactor/IndustryRisk/rating/${RiskAnalysisIndustryRateingMstID}`
                );
              }}
            >
      ...
      <IndustryRatingQuickEditForm
        currentIndustryRating={row}
...
IndustryRatingTableRow.propTypes = {
