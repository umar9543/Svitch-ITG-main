...
import { AUDIT_KPI_STATUS_OPTIONS } from 'src/_mock';
...
export default function QaPreviewQuickEditForm({ currentKpi, open, onClose }) {
  const { enqueueSnackbar } = useSnackbar();

  const NewQaPreviewSchema = Yup.object().shape({
        ...
        <DialogContent>
          ...
          >
            <RHFSelect name="status" label="Status">
              {AUDIT_KPI_STATUS_OPTIONS.map((status) => (
...
QaPreviewQuickEditForm.propTypes = {
  open: PropTypes.bool,
