...
import CountryRatingQuickEditForm from './CountryRating-quick-edit-form';
...
export default function CountryRatingTableRow({
  row,
  selected,
  onEditRow,
  onSelectRow,
  ...
  const { RiskAnalysisCountryRateingMstID, CreationDate, CountryName, LawDescription } = row;
  ...
  return (
    <>
      <TableRow hover selected={selected}>
        ...
        {/* <TableCell sx={{ whiteSpace: 'nowrap' }}>{LawDescription}</TableCell> */}
        ...
        <TableCell sx={{ whiteSpace: 'nowrap', textAlign: 'right' }}>
          <Tooltip title="Edit" placement="top" arrow>
            <IconButton
              ...
              onClick={() => {
                router.push(
                  `/dashboard/RiskAnalysis/RiskFactor/CountryRisk/rating/${RiskAnalysisCountryRateingMstID}`
                );
              }}
            >
      ...
      <CountryRatingQuickEditForm
        currentCountryRating={row}
...
CountryRatingTableRow.propTypes = {
