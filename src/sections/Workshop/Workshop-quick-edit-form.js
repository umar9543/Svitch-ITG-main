...
export default function WorkshopQuickEditForm({ currentWorkshop, open, onClose }) {
  ...
  const defaultValues = useMemo(
    () => ({
      ...
      phoneNumber: currentWorkshop?.phoneNumber || '',
      address: currentWorkshop?.address || '',
      country: currentWorkshop?.country || '',
      state: currentWorkshop?.state || '',
      city: currentWorkshop?.city || '',
      zipCode: currentWorkshop?.zipCode || '',
      status: currentWorkshop?.status,
      company: currentWorkshop?.company || '',
...
WorkshopQuickEditForm.propTypes = {
  open: PropTypes.bool,
