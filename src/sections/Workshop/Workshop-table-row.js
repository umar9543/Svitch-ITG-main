...
import WorkshopQuickEditForm from './Workshop-quick-edit-form';
import { Box } from '@mui/system';

// ----------------------------------------------------------------------

export default function WorkshopTableRow({ row, selected, onEditRow, onSelectRow, onDeleteRow }) {
    ...
    <>
      <TableRow hover selected={selected}>
        ...
        <TableCell sx={{ whiteSpace: 'nowrap', textAlign: 'center' }}>
          <Box sx={{ color: 'default', display: 'flex', justifyContent: 'space-around' }}>
            {100} <Iconify icon="solar:pen-bold" />
          </Box>
        </TableCell>
        <TableCell sx={{ whiteSpace: 'nowrap', textAlign: 'center' }}>
          <Box sx={{ color: 'default', display: 'flex', justifyContent: 'space-around' }}>
