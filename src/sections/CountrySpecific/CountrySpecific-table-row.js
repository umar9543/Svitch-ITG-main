...
import CountrySpecificQuickEditForm from './CountrySpecific-quick-edit-form';
...
export default function CountrySpecificTableRow({
  row,
  selected,
  onEditRow,
  onSelectRow,
  ...
  return (
    <>
      ...
      <CountrySpecificQuickEditForm
        currentCountrySpecific={row}
...
CountrySpecificTableRow.propTypes = {
