...
import { INVITATION_STATUS_OPTIONS } from 'src/_mock';
...
export default function InvitationQuickEditForm({ currentInvitation, open, onClose }) {
...
InvitationQuickEditForm.propTypes = {
  open: PropTypes.bool,
