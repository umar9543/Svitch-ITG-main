...
import BasicRiskQuickEditForm from './BasicRisk-quick-edit-form';
...
export default function BasicRiskTableRow({ row, selected, onEditRow, onSelectRow, onDeleteRow }) {
  const { CountryName, BasicName, Discription, BasicRisk, BasicRiskID } = row;
  ...
  return (
    <>
      <TableRow hover selected={selected}>
        ...
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{BasicName}</TableCell>
        <TableCell sx={{ whiteSpace: '' }}>{Discription}</TableCell>
        <TableCell sx={{ whiteSpace: '', textAlign: 'center' }}>{BasicRisk}</TableCell>
      ...
      <BasicRiskQuickEditForm
        currentBasicRisk={row}
