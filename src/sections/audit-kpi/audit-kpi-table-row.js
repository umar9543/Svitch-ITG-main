...
import AuditKpiQuickEditForm from './audit-kpi-quick-edit-form';

// ----------------------------------------------------------------------

export default function AuditKpiTableRow({ row, selected, onEditRow, onSelectRow, onDeleteRow }) {
