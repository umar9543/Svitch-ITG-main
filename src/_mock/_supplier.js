...
export const _supplierFollowers = [...Array(18)].map((_, index) => ({
  id: _mock.id(index),
...
export const _supplierFriends = [...Array(18)].map((_, index) => ({
  id: _mock.id(index),
...
export const _supplierGallery = [...Array(12)].map((_, index) => ({
  id: _mock.id(index),
...
export const _supplierFeeds = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
...
export const _supplierCards = [...Array(21)].map((_, index) => ({
  id: _mock.id(index),
  role: _mock.role(index),
  name: _mock.fullName(index),
...
export const _supplierPayment = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
...
export const _supplierAddressBook = [...Array(4)].map((_, index) => ({
  id: _mock.id(index),
  primary: index === 0,
  name: _mock.fullName(index),
...
export const _supplierInvoices = [...Array(10)].map((_, index) => ({
  id: _mock.id(index),
...
export const _supplierList = [...Array(20)].map((_, index) => ({
  id: _mock.id(index),
  zipCode: '85807',
  state: 'Virginia',
  city: 'Rancho Cordova',
