...
export const _kpiFollowers = [...Array(18)].map((_, index) => ({
  id: _mock.id(index),
...
export const _kpiFriends = [...Array(18)].map((_, index) => ({
  id: _mock.id(index),
...
export const _kpiGallery = [...Array(12)].map((_, index) => ({
  id: _mock.id(index),
...
export const _kpiFeeds = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
...
export const _kpiCards = [...Array(21)].map((_, index) => ({
  id: _mock.id(index),
  role: _mock.role(index),
  name: _mock.fullName(index),
...
export const _kpiPayment = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
...
export const _kpiAddressBook = [...Array(4)].map((_, index) => ({
  id: _mock.id(index),
  primary: index === 0,
  name: _mock.fullName(index),
...
export const _kpiInvoices = [...Array(10)].map((_, index) => ({
  id: _mock.id(index),
...
export const _kpiList = [...Array(20)].map((_, index) => ({
  id: _mock.id(index),
  zipCode: '85807',
  state: 'Virginia',
  city: 'Rancho Cordova',
