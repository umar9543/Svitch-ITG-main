...
export const _invitationFollowers = [...Array(18)].map((_, index) => ({
  id: _mock.id(index),
...
export const _invitationFriends = [...Array(18)].map((_, index) => ({
  id: _mock.id(index),
...
export const _invitationGallery = [...Array(12)].map((_, index) => ({
  id: _mock.id(index),
...
export const _invitationFeeds = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
...
export const _invitationCards = [...Array(21)].map((_, index) => ({
  id: _mock.id(index),
  role: _mock.role(index),
  name: _mock.fullName(index),
...
export const _invitationPayment = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
...
export const _invitationAddressBook = [...Array(4)].map((_, index) => ({
  id: _mock.id(index),
  primary: index === 0,
  name: _mock.fullName(index),
...
export const _invitationInvoices = [...Array(10)].map((_, index) => ({
  id: _mock.id(index),
...
export const _invitationList = [...Array(20)].map((_, index) => ({
  id: _mock.id(index),
  zipCode: '85807',
  state: 'Virginia',
  city: 'Rancho Cordova',
