...
export const _postTitles = [
  ...
  'Strong partnerships begin with a seamless onboarding process.',
  'Empowering growth by bringing the right suppliers onboard.',
...
export const _sentences = [
  ...
  'By ensuring a smooth onboarding process, we lay the foundation for strong, lasting partnerships.',
  'By carefully selecting and efficiently onboarding the right suppliers',
