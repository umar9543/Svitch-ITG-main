...
export const KPI_PROD_STATUS_OPTIONS = [
...
export const _kpiProductivityAbout = {
  id: _mock.id(1),
  role: _mock.role(1),
  email: _mock.email(1),
...
export const _kpiProductivityFollowers = [...Array(18)].map((_, index) => ({
  id: _mock.id(index),
...
export const _kpiProductivityFriends = [...Array(18)].map((_, index) => ({
  id: _mock.id(index),
...
export const _kpiProductivityGallery = [...Array(12)].map((_, index) => ({
  id: _mock.id(index),
...
export const _kpiProductivityFeeds = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
...
export const _kpiProductivityCards = [...Array(21)].map((_, index) => ({
  id: _mock.id(index),
  role: _mock.role(index),
  name: _mock.fullName(index),
...
export const _kpiProductivityPayment = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
...
export const _kpiProductivityAddressBook = [...Array(4)].map((_, index) => ({
  id: _mock.id(index),
  primary: index === 0,
  name: _mock.fullName(index),
...
export const _kpiProductivityInvoices = [...Array(10)].map((_, index) => ({
  id: _mock.id(index),
...
export const _kpiProductivityPlans = [
  {
    subscription: 'basic',
    price: 0,
    primary: false,
...
export const _kpiProductivityList = [...Array(20)].map((_, index) => ({
  id: _mock.id(index),
  zipCode: '85807',
  state: 'Virginia',
  city: 'Rancho Cordova',
