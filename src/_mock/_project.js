...
export const _projectFollowers = [...Array(18)].map((_, index) => ({
  id: _mock.id(index),
...
export const _projectFriends = [...Array(18)].map((_, index) => ({
  id: _mock.id(index),
...
export const _projectGallery = [...Array(12)].map((_, index) => ({
  id: _mock.id(index),
...
export const _projectFeeds = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
...
export const _projectCards = [...Array(21)].map((_, index) => ({
  id: _mock.id(index),
  role: _mock.role(index),
  name: _mock.fullName(index),
...
export const _projectPayment = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
...
export const _projectAddressBook = [...Array(4)].map((_, index) => ({
  id: _mock.id(index),
  primary: index === 0,
  name: _mock.fullName(index),
...
export const _projectInvoices = [...Array(10)].map((_, index) => ({
  id: _mock.id(index),
...
export const _projectList = [...Array(20)].map((_, index) => ({
  id: _mock.id(index),
  zipCode: '85807',
  state: 'Virginia',
  city: 'Rancho Cordova',
