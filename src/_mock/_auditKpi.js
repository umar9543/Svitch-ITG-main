...
export const AUDIT_KPI_STATUS_OPTIONS = [
...
export const _AuditKpiFollowers = [...Array(18)].map((_, index) => ({
  id: _mock.id(index),
...
export const _AuditKpiFriends = [...Array(18)].map((_, index) => ({
  id: _mock.id(index),
...
export const _AuditKpiGallery = [...Array(12)].map((_, index) => ({
  id: _mock.id(index),
...
export const _AuditKpiFeeds = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
...
export const _AuditKpiCards = [...Array(21)].map((_, index) => ({
  id: _mock.id(index),
  role: _mock.role(index),
  name: _mock.fullName(index),
...
export const _AuditKpiPayment = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
...
export const _AuditKpiAddressBook = [...Array(4)].map((_, index) => ({
  id: _mock.id(index),
  primary: index === 0,
  name: _mock.fullName(index),
...
export const _AuditKpiInvoices = [...Array(10)].map((_, index) => ({
  id: _mock.id(index),
...
export const _AuditKpiList = [...Array(20)].map((_, index) => ({
  id: _mock.id(index),
  zipCode: '85807',
  state: 'Virginia',
  city: 'Rancho Cordova',
